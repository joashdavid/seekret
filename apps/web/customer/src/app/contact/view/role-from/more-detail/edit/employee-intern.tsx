...
import { updateEmployeeInternConsultantApi } from './api'

const MoreDetailsEmployeeInternModal = (props: {
  onOk: () => void
  onCancel: () => void
  ...
  const updateClient = async () => {
    if (props.data) {
      const response = await updateEmployeeInternConsultantApi(
        props.orgId,
...
export { MoreDetailsEmployeeInternModal }
