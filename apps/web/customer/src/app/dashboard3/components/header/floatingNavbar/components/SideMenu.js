...
export const menuItems = [
  {
    ...
    subMenus: [
      { name: "Contact", to: "/dashboard/createOrg", iconClassName: "icon-Contact_Icon" },
  ...
  },
  {
    ...
    closeIconClassName: "bi bi-chevron-up",
    subMenus: [
      { name: "Organization", to: "/dashboard/manageOrg", iconClassName: "icon-Organization_Icon"},
      { name: "Contact", to: "/dashboard/manageContact", iconClassName: "icon-Contact_Icon"},
      { name: "Project", to: "/content/Project", iconClassName: "icon-Project_Icon"},
